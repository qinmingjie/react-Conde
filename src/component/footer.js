...
function Footer(){
    return(
        <Layout.Footer className="setColor" id="foot">
            <div id="footer_main" className="wrap">
                <div className="links">
                ...
                <div className="col_fade">
                    ...
                    ，由<a href="https://www.aliyun.com/product/nodejs?ref=cnode" target="_blank" className="sponsor_outlink" data-label="alinode_bottom">
                        <img src="//static.cnodejs.org/FpMZk31PDyxkC8yStmMQL4XroaGD" title="alinode" alt="alinode" width="166px" height="54px"/>
                        </a>提供应用性能服务。
                    </p>
